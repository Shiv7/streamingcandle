...
/**
 * Multi-minute timestamp extractor for OI rollups.
 * Prefer START time of 1m aggregate, then END, and shift by per-exchange offset.
 */
public class MultiMinuteOffsetTimestampExtractorForOI implements TimestampExtractor {

    private final int windowSizeMinutes;

    public MultiMinuteOffsetTimestampExtractorForOI(int windowSizeMinutes) {
    ...
    public long extract(ConsumerRecord<Object, Object> record, long partitionTime) {
        ...
        long baseTs = 0L;
        if (v instanceof OIAggregate agg) {
